...
import { MapTab } from "./components/map-tab.jsx?v=20260520.1003";
import { WaypointEditor } from "./components/waypoint-editor.jsx?v=20260520.1003";
import { SetupTab } from "./components/setup-tab.jsx?v=20260520.1003";
import { FlightTab } from "./components/flight-tab.jsx?v=20260520.1003";
import { FuelTab } from "./components/fuel-tab.jsx?v=20260520.1003";
import { LogTab } from "./components/log-tab.jsx?v=20260520.1003";
import { PrefsPanel } from "./components/prefs-panel.jsx?v=20260520.1003";
import { ErrorBoundary } from "./components/error-boundary.jsx?v=20260520.1003";
import { RoutesManager } from "./components/routes-manager.jsx?v=20260520.1003";
import { AtaEditor } from "./components/ata-editor.jsx?v=20260520.1003";
import { NotesEditor } from "./components/notes-editor.jsx?v=20260520.1003";
import { DeviationPanel } from "./components/deviation-panel.jsx?v=20260520.1003";
import { FPLImporter } from "./components/fpl-importer.jsx?v=20260520.1003";
import { FleetManager, AircraftEditor } from "./components/fleet-manager.jsx?v=20260520.1003";
import { useDerivedFlight } from "./hooks/use-derived-flight.jsx?v=20260520.1003";
import { useFlightActions } from "./hooks/use-flight-actions.jsx?v=20260520.1003";
import { useFlightPersistence } from "./hooks/use-flight-persistence.jsx?v=20260520.1003";
import { AppProvider } from "./context/app-context.jsx?v=20260520.1003";
import { TabButton, LiveClock } from "./components/ui-primitives.jsx?v=20260520.1003";
import { IconButton } from "./ui/button.jsx?v=20260520.1003";
...
(function _requiredGlobalsGuard() {
  const required = [
    ...
    "parseCoordsString", "decDegToStr", "formatCoord", "ddmDigitsToDecDeg", "roundCoord",
    "MINUTES_PER_DAY",
...
const APP_VERSION = "20260520.1003";
